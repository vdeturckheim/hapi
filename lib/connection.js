...
exports = module.exports = internals.Connection = class extends Podium {
    constructor(server, options) {

        const now = Date.now();

        super(internals.Connection._events);
